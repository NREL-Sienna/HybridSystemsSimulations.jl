...
# Prices
CSV.write("scripts/bilevel_pipeline/inputs/chuhsi_DA_prices.csv", DA_prices)
CSV.write("scripts/bilevel_pipeline/inputs/chuhsi_RT_prices.csv", RT_prices)
...
CSV.write("scripts/bilevel_pipeline/inputs/chuhsi_RegUp_prices.csv", df_up)
CSV.write("scripts/bilevel_pipeline/inputs/chuhsi_RegDown_prices.csv", df_dn)
CSV.write("scripts/bilevel_pipeline/inputs/chuhsi_Spin_prices.csv", df_spin)
