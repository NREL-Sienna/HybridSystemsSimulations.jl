#@testset "Hybrid DCPLossLess with HybridEnergyOnlyDispatchDispatch formulation" begin
#    device_model = DeviceModel(HybridSystem, HybridEnergyOnlyDispatchDispatch)
...
#end
#
#@testset "Hybrid ACPPowerModel with HybridEnergyOnlyDispatchDispatch formulation" begin
#    device_model = DeviceModel(HybridSystem, HybridEnergyOnlyDispatchDispatch)
#    sys = PSB.build_system(PSITestSystems, "c_sys5_hybrid")
#
...
#end
#
#@testset "Hybrid DCPLossLess HybridEnergyOnlyDispatchDispatch" begin
