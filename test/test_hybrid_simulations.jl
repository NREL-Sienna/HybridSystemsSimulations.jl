@testset "Test HybridSystem simulations" begin
    ...
    set_device_model!(template_uc, PSY.HybridSystem, HybridEnergyOnlyDispatchDispatch)
...
@testset "Test HybridSystem simulations" begin
    ...
    set_device_model!(template_ed, PSY.HybridSystem, HybridEnergyOnlyDispatchDispatch)
